                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="search" value="Search Here"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="tel" value="1-(222)-333-74444"
                                    ...
                                    <div class="mb-3 mb-lg-0 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="datetime-local"
                                                value="2023-05-16T05:07:00" id="example-datetime-local-input">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="row mb-3 mt-3 mt-xl-0">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="date" value="2023-08-20"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="month" value="2023-08"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="week" value="2023-W33"
