                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="nummber" value="Hello World"
                                ...
                                <div class="col-xl-6">
                                <div class="mb-3 row">
                                        <label for="example-email-input" class="col-md-2 col-form-label">ProductId</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="number" value="44"
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-password-input"
                                            class="col-md-2 col-form-label">CurrentQuantity</label>
                                        <div class="col-md-10">
