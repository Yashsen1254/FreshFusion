        ...
        <header class="top-header-area top-menu-header">
            <div class="d-flex align-items-center justify-content-between">
                <div class="left-side-content-area d-flex align-items-center">
                    <!-- Top Logo -->
                    <div class="top-logo">
                        <a href="index-2.html"><img src="img/core-img/small-logo.png" alt="Top Logo"></a>
                    </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="top-message-area">
                                    ...
                                    <div class="notifications-box" id="messageBox">
                                ...
                                <div class="top-notifications-area">
                                    ...
                                    <div class="notifications-box" id="notificationsBox">
                                        <a href="#" class="dropdown-item">
                                            ...
                                            <div>
                                                <span>Your order is placed</span>
                                                <p class="mb-0 font-12">Consectetur adipisicing elit. Ipsa, porro!
                                                </p>
                                            </div>
                                        </a>
