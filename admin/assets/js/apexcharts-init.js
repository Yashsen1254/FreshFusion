...
(chart = new ApexCharts(document.querySelector("#line-chart-das"), options)).render(),
(options = {
...
(chart = new ApexCharts(document.querySelector("#column-chart-area"), options)).render(),
(options = {
    chart: { height: 350, type: "bar", toolbar: { show: !1 } },
...
(options = {
    ...
    colors: ["#0652DD", "#fcb92c", "#6fbe36", "#ff5d5d"],
    legend: { offsetY: 5 },
}),
...
(options = {
    ...
    colors: ["#6fbe36", "#0652DD", "#fcb92c", "#2ec8f1", "#ff5d5d"],
