...
<script src="<?= urlOf('assets/js/apexcharts.min.js'); ?>"></script>
<script src="<?= urlOf('assets/js/intro.min.js'); ?>"></script>
<script src="<?= urlOf('assets/js/dashboard-custom.js'); ?>"></script>
<script src="<?= urlOf('assets/js/intro-active.js'); ?>"></script>
<script src="<?= urlOf('assets/js/jquery.dataTables.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/dataTables.bootstrap5.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/dataTables.responsive.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/dataTables.buttons.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/buttons.print.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/pdfmake.min.js') ?>"></script>
<script src="<?= urlOf('assets/js/vfs_fonts.js') ?>"></script>
...
<script src="<?= urlOf('assets/js/jquery.bootstrap-touchspin.min.js')?>"></script>
